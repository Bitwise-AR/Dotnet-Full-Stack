...
namespace University_Course_Registration_System
{
    ...
    public class Student
    {
        ...
        public bool DropCourse(string courseCode)
        {
            ...
            if (RegisteredCourses.Any(c => c.CourseCode == courseCode))
            {
        ...
        public void DisplaySchedule()
        {
            ...
            foreach (var course in RegisteredCourses)
                Console.WriteLine($"Course Code: {course.CourseCode}, Course Name: {course.CourseName}, Credits: {course.Credits}");
        }
    }
}
